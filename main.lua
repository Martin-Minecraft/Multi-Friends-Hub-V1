...
Gamer:Button("Multi-Friends-Hub-V1",function()

loadstring(game:HttpGet("https://raw.githubusercontent.com/Martin-Minecraft/Multi-Friends-Hub-V1/master/Hub.lua"))();

end)

local Gamer2 = library:CreateSection("library's");

Gamer2:Button("finity UI",function()
...
Gamer2:Button("OwlHub UI Library",function()

local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/CriShoux/OwlHub/master/UILib.lua"))();
